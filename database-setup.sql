...
BEGIN
  ...
  INSERT INTO restaurants (name, slug, description, whatsapp_number, primary_color, logo_url, banner_url, address, instagram, facebook)
  VALUES (
  ...
  RAISE NOTICE '✅ Restaurantes creados: 1';
...
-- LISTO! 🎉
-- ================================================
-- Ahora puedes acceder a tu menú en:
-- http://localhost:3000/#/menu/sabor
-- O cuando despliegues:
-- https://tu-proyecto.vercel.app/#/menu/sabor
-- ================================================
